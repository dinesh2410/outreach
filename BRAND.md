...
## Don't
- Promise specific user numbers ("100 users", etc.)
- Lean on "listings" as the brand frame — it's too narrow
- Sound like a marketing team
- Use hype language or superlatives
- Credit any third-party tools for features we'll build ourselves
